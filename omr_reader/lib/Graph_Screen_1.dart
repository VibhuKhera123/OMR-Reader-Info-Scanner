...
List<Color> gradient_clr = [const Color(0xff23b6eb), const Color(0xff02d39a)];
  ...
  static List<Stud_data_graph> getData() {
    return <Stud_data_graph>[
      ...
      for (var i = 0; i < length_data_pts; i++)
        Stud_data_graph(
            x_pt: analysis_data['Ques_No'][i],
            y_pt: analysis_data['Right_Answers'][i]),
    ];
  }
}
        ...
        itemBuilder: (BuildContext context, int index) {
          return Column(
            ...
            children: [
              // Bell Curve
              const Divider(),
              const Text("Right Answers Frequency"),
              const Padding(
                    ...
                    LineChartBarData(
                      spots: [
                        for (var i = 0; i < length_data_pts; i++)
                          ...
                          FlSpot(data_points[i].x_pt.toDouble(),
                              data_points[i].y_pt.toDouble())
                      ],
                      // To Smooth out curve
                      isCurved: false,
                      // Color of Line
                      gradient: LinearGradient(colors: gradient_clr),
                      // Thickness of Line
                      barWidth: 5,
                    ),
                  ],
              ...
              Container(
                  ...
                  child: (Text(
                      "Class Average: ${analysis_data['Avg_Marks'].toString()}"))),
              ...
              Container(
                  ...
                  padding: const EdgeInsets.only(left: 5, top: 35),
                  child: (Text(
                      "Class Accuracy: ${analysis_data['Class_Accuracy'].toString()}%"))),
              ...
              Container(
                  ...
                  padding: const EdgeInsets.only(left: 5, top: 35),
                  child: (Text(
                      "Total Test Takers: ${analysis_data['Enroll_id'].length.toString()}"))),
